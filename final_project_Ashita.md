...
**Note:** I had originally created two heatmaps showing the heart disease mortality rates in 2005 and 2015 in the United States. I used Infogram to create them. However, I chose to not use this data heading into week 2. I had limited number of templates available for use in the free version of Infogram and unintentionally deleted the heatmaps so I could use the template for a different visualization in my final data story. As a result, the heatmaps are no longer shown below. 
